...
function Sprite(src, x, y) {
  ...
  self.image.src    = "flowers/" + src + ".png";
...
var bss = [new Sprite("b1",   0,   0), new Sprite("b2", 0,   0), new Sprite("b3",   0,   0)];
var iss = [new Sprite("i1", 480, 560), new Sprite("i2", 0, 560), new Sprite("i3", 240, 560)];
